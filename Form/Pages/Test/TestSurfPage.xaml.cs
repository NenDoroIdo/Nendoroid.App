...
namespace Form.Pages.Test
{
	[XamlCompilation(XamlCompilationOptions.Compile)]
	public partial class TestSurfPage : ContentPage
	{
        #region FIELDS
        ...
        */
        ...
        private void OnDetectButtonClicked(object sender, EventArgs args)
        {
            ...
            if (objects.Length > 0)
            {
                var marker = new RectanglesMarker(objects, System.Drawing.Color.FromArgb(0xff, 0xff, 0x00, 0xff));
